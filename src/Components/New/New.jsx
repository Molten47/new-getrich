  ...
  return (
    <div className="table-container bg-black text-white min-h-screen py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-[40px] font-bold text-center mb-8">Welcome Back!</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-[#0C0C0C] p-8 rounded-lg shadow-lg">
         ...
         <Link to="/registration"><span className='relative active:shadow-md active:shadow-orange-400/30 text-[#ddca87] hover:text-amber-300'>Register</span></Link>
         </div>
